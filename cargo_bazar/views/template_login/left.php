                    ...
                    <ul class="chat-contacts">
                            ...
                            <a href="#">
                                <div class="media">
                                    <div class="pull-left">
                                        ...
                                        <img src="<?php echo base_url() ?>assets/usertheme/images/guy-6.jpg" width="40" class="img-circle">
                                    </div>
                        ...
                        <li class="online away" data-user-id="2">
                            <a href="#">
                                ...
                                <div class="media">
                                    <div class="pull-left">
                                        <span class="status"></span>
                                        <img src="<?php echo base_url() ?>assets/usertheme/images/woman-5.jpg" width="40" class="img-circle">
                                    </div>
                                    <div class="media-body">
                        ...
                        <li class="online" data-user-id="3">
                            <a href="#">
                                <div class="media">
                                    <div class="pull-left ">
                                        <span class="status"></span>
                                        <img src="<?php echo base_url() ?>assets/usertheme/images/guy-3.jpg" width="40" class="img-circle">
                                    </div>
                                    <div class="media-body">
                        ...
                        <li class="offline" data-user-id="4">
                            <a href="#">
                                <div class="media">
                                    <div class="pull-left">
                                        <img src="<?php echo base_url() ?>assets/usertheme/images/woman-6.jpg" width="40" class="img-circle">
                                    </div>
                                    <div class="media-body">
                        ...
                        <li class="offline" data-user-id="5">
                            <a href="#">
                                <div class="media">
                                    <div class="pull-left">
                                        <img src="<?php echo base_url() ?>assets/usertheme/images/woman-7.jpg" width="40" class="img-circle">
                                    </div>
                                    <div class="media-body">
                        ...
                        <li class="online" data-user-id="6">
                            <a href="#">
                                <div class="media">
                                    <div class="pull-left">
                                        <span class="status"></span>
                                        <img src="<?php echo base_url() ?>assets/usertheme/images/guy-4.jpg" width="40" class="img-circle">
                                    </div>
                                    <div class="media-body">
                        ...
                        <li class="offline" data-user-id="8">
                            <a href="#">
                                <div class="media">
                                    <div class="pull-left">
                                        <span class="status"></span>
                                        <img src="<?php echo base_url() ?>assets/usertheme/images/woman-8.jpg" width="40" class="img-circle">
                                    </div>
                                    <div class="media-body">
                        ...
                        <li class="online away" data-user-id="9">
                            <a href="#">
                                <div class="media">
                                    <div class="pull-left">
                                        <span class="status"></span>
                                        <img src="<?php echo base_url() ?>assets/usertheme/images/woman-9.jpg" width="40" class="img-circle">
                                    </div>
                                    <div class="media-body">
